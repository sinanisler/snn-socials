<?php
/**
 * GitHub Auto-Update for SNN Socials Plugin
 *
...
$github_repo_name  = 'snn-socials';
$plugin_slug       = 'snn-socials';
$plugin_file       = 'snn-socials/snn-socials.php';

/**
 * Check for Plugin Updates from GitHub
 */
add_filter('pre_set_site_transient_update_plugins', 'snn_socials_check_github_update');
function snn_socials_check_github_update($transient) {
 ...
 */
add_filter('plugins_api', 'snn_socials_plugin_info_from_github', 10, 3);
function snn_socials_plugin_info_from_github($result, $action, $args) {
    global $github_repo_owner, $github_repo_name, $plugin_slug, $plugin_file;
    ...
    $changelog = !empty($release_data->body)
        ...
        : __('See GitHub release notes for details.', 'snn-socials');
    ...
    $result = (object) array(
        ...
        'sections'      => array(
            'description' => $plugin_data['Description'] ?? __('Publish images and videos to X (Twitter), LinkedIn, Instagram, and YouTube from your WordPress dashboard.', 'snn-socials'),
 ...
 */
add_action('admin_footer', 'snn_socials_github_redirect_version_link');
function snn_socials_github_redirect_version_link() {
    ...
    <script type="text/javascript">
        (function() {
            ...
            function processLinks() {
                ...
                const links = document.querySelectorAll('.plugin-title a, .update-message a, a[aria-label*="SNN Socials"]');
